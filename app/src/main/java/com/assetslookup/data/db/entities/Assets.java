...
public class Assets {
  ...
  public Assets(String userId, String name, String code, boolean autorefresh, Double balance, Double irr, String groupA, String groupB, String groupC, List<Movement> movements) {
    this.userId = userId;
    this.name = name;
    this.code = code;
