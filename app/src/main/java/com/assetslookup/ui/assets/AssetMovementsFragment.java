...
public class AssetMovementsFragment extends BaseChildNestedFragment
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    assetMovementsListShadow = view.findViewById(R.id.assetMovementsListShadow);
    ...
    assetMovementsList.addOnScrollListener(new RecyclerView.OnScrollListener() {
      @Override
      ...
      public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
        ...
        scrollY += dy;
        if(scrollY > 50) assetMovementsListShadow.setVisibility(View.VISIBLE);
        else assetMovementsListShadow.setVisibility(View.INVISIBLE);
      }
    });
        ...
        if(response.code() == 200) {
          if(response.body() != null) {
            ...
            if(asset.getUnit() != null){
              txtUnitPrice.setText(numberFormatCurrency.format(asset.getUnit()));
            }
            else{
            ...
            if(asset.getUnit() != null && asset.getBalance() != null ){
              txtTotal.setText( numberFormatCurrency.format(asset.getBalance() * asset.getUnit()));
            }
            else {
              txtTotal.setText( numberFormatCurrency.format(0));
            }
